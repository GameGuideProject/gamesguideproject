...
if (isset($_POST['value'])) {
    $value=$_POST['value'];
    $query = "SELECT DISTINCT `game`.`name` ,`Short description`, `Icon`, `BackGround` FROM `game`,`gameplatforms` WHERE `gameplatforms`.`Platform`='$value' And `game`.`name`= `gameplatforms`.`name`";
   // echo $query;
